...
<div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
 ...
 <div class="container-fluid" id="main-content">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['roomId'])) {
      ...
      $sql = "DELETE FROM RoomInformation WHERE RoomID = ?";
                ...
                <div class="card mb-4 border-0 shadow">
                    <div class="row g-0 p-3 align-items-center">
                        ...
                        <div class="col-md-5 px-lg-3 px-md-3 px-0">
                            ...
                            <!-- Delete Button -->
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this room?');">
                                <input type="hidden" name="roomId" value="<?php echo $row['RoomID']; ?>">
                                <button type="submit" class="btn btn-sm w-100 text-dark custom-bg shadow-none mb-2">Delete</button>
                            </form>
                            <!-- Conditional Button based on Accepted value -->
                            <?php if ($Accepted == 1): ?>
                                <button type="button" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2" disabled>Accepted</button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
