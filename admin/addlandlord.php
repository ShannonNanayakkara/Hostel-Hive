 ...
 <div class="container-fluid" id="main-content">
    ...
    <div class="modal-header">
        <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-person-lines-fill fs-3 me-2"></i>Landlord Registration
        </h5>
    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO landloard (name, email, phone_number, address, date_of_birth, password)
            VALUES ('$name', '$email', '$phone_number', '$address', '$date_of_birth', '$password')";

    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("New landloard added successfully");</script>';
    } else {
